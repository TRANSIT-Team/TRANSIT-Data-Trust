...
@Component
public abstract class CrudControllerSubRessourceAbstract<test, testDTO extends AbstractDTOIdCanBeNull<testDTO>, testRoot, testRootDTO, rootController extends CrudControllerExtend<testRootDTO, UUID>, nestedController extends CrudControllerSubResource<testDTO, UUID, UUID>> {
	...
	public abstract AssemblerWrapperSubAbstract<test, testDTO, testRoot, testRootDTO, rootController, nestedController> getAssemblerWrapper();
