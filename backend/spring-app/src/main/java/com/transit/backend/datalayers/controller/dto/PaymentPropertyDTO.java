...
@NoArgsConstructor
@ToString
@Relation(collectionRelation = "paymentProperties", itemRelation = "paymentProperty")
public class PaymentPropertyDTO extends AbstractDTOIdCanBeNull<PaymentPropertyDTO> implements Comparable<PaymentPropertyDTO> {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof PaymentPropertyDTO that)) return false;
	...
	@Override
	public int compareTo(@NotNull PaymentPropertyDTO o) {
