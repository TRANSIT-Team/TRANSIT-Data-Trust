...
@AllArgsConstructor
@NoArgsConstructor
@Relation(collectionRelation = "userProperties", itemRelation = "userProperty")
public class UserPropertyDTO extends AbstractDTOIdCanBeNull<UserPropertyDTO> implements Comparable<UserPropertyDTO> {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof UserPropertyDTO that)) return false;
	...
	@Override
	public int compareTo(@NotNull UserPropertyDTO o) {
