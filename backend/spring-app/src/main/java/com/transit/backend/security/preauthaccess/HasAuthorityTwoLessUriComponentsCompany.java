...
@Service("securityTwoLess")
public class HasAuthorityTwoLessUriComponentsCompany {
	...
	public final boolean hasAnyAuthority(String... authorities) {
		...
		try {
			...
			var rights = this.rightsService.getAccess(userHelperFunctions.getOIdFromCompany(entityUUID), companyId);
			if (companyId == null) {
				return false;
			}
