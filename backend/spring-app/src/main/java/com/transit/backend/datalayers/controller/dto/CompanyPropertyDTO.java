...
@AllArgsConstructor
@NoArgsConstructor
@Relation(collectionRelation = "companyProperties", itemRelation = "companyProperty")
public class CompanyPropertyDTO extends AbstractDTOIdCanBeNull<CompanyPropertyDTO> implements Comparable<CompanyPropertyDTO> {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof CompanyPropertyDTO that)) return false;
	...
	@Override
	public int compareTo(@NotNull CompanyPropertyDTO o) {
