...
@AllArgsConstructor
@NoArgsConstructor
public class AbstractDTOIdCanBeNull<P extends AbstractDTOIdCanBeNull<P>> extends BaseTypeDTO<P> implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof AbstractDTOIdCanBeNull<?> that)) return false;
