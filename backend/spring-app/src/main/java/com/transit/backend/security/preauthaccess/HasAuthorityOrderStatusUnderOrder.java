...
@Service("securityServiceOrderStatus")
public class HasAuthorityOrderStatusUnderOrder {
	...
	public final boolean hasAnyAuthority(String... authorities) {
		...
		var orderUriComponent = uriComponents.getPathSegments().get(uriComponents.getPathSegments().size() - 2);
