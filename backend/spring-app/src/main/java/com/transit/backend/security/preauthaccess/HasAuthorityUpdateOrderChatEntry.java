...
@Service("securityUpdateChatService")
@Slf4j
public class HasAuthorityUpdateOrderChatEntry {
	...
	public final boolean hasAnyAuthority(String... authorities) {
		...
		var orderId = uriComponents.getPathSegments().get(uriComponents.getPathSegments().size() - 3);
