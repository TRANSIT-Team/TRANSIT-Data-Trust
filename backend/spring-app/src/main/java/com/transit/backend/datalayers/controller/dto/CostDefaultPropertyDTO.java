...
@NoArgsConstructor
@ToString
@Relation(collectionRelation = "costDefaultProperties", itemRelation = "costDefaultProperty")
public class CostDefaultPropertyDTO extends AbstractDTO<CostDefaultPropertyDTO> {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof CostDefaultPropertyDTO)) return false;
		if (!super.equals(o)) return false;
		CostDefaultPropertyDTO that = (CostDefaultPropertyDTO) o;
