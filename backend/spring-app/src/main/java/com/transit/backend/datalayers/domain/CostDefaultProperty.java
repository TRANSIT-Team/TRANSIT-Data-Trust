...
@NoArgsConstructor
@AllArgsConstructor
@Entity(name = "CostDefaultProperty")
@Table(name = "costDefaultProperties")
@Audited(withModifiedFlag = true)
public class CostDefaultProperty extends AbstractEntity implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof CostDefaultProperty)) return false;
		if (!super.equals(o)) return false;
		CostDefaultProperty that = (CostDefaultProperty) o;
