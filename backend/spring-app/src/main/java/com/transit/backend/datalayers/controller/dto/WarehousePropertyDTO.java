...
@AllArgsConstructor
@NoArgsConstructor
@Relation(collectionRelation = "warehouseProperties", itemRelation = "warehouseProperty")

public class WarehousePropertyDTO extends AbstractDTOIdCanBeNull<WarehousePropertyDTO> implements Comparable<WarehousePropertyDTO> {
	...
	public boolean equals(Object o) {
		...
		WarehousePropertyDTO that = (WarehousePropertyDTO) o;
	...
	@Override
	public int compareTo(@NotNull WarehousePropertyDTO o) {
