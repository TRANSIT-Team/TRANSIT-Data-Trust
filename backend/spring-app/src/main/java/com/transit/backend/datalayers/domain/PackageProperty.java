...
@NoArgsConstructor
@AllArgsConstructor
@Entity(name = "PackageProperty")
@Table(name = "packageProperties")
@Audited(withModifiedFlag = true)
@Cache(region = "packagePropertyCache", usage = CacheConcurrencyStrategy.TRANSACTIONAL)
public class PackageProperty extends AbstractEntity implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof PackageProperty)) return false;
		if (!super.equals(o)) return false;
		PackageProperty that = (PackageProperty) o;
