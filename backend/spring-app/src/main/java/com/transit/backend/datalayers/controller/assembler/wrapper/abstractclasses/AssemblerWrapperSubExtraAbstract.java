...
@Component
public abstract class AssemblerWrapperSubExtraAbstract<test, testDTO extends AbstractDTO<testDTO>, testRoot, testRootDTO, rootController extends CrudControllerExtend<testRootDTO, UUID>, subController extends CrudControllerSubResource<testDTO, UUID, UUID>> {
