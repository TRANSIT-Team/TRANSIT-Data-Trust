...
public class AddressDTO extends AbstractDTO<AddressDTO> {
	...
	public boolean equals(Object o) {
		...
		return Objects.equal(locationPoint, that.locationPoint) && Objects.equal(street, that.street) && Objects.equal(zip, that.zip) && Objects.equal(city, that.city) && Objects.equal(state, that.state) && Objects.equal(country, that.country) && Objects.equal(isoCode, that.isoCode) && Objects.equal(addressExtra, that.addressExtra) && Objects.equal(companyName, that.companyName) && Objects.equal(clientName, that.clientName);
	}
	
	@Override
	public int hashCode() {
		return Objects.hashCode(super.hashCode(), locationPoint, street, zip, city, state, country, isoCode, addressExtra, companyName, clientName);
	}
}
