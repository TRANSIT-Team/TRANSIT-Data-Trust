...
@NoArgsConstructor
@ToString
@Relation(collectionRelation = "orderTypeProperties", itemRelation = "orderTypeProperty")
public class OrderTypePropertyDTO extends AbstractDTOIdCanBeNull<OrderTypePropertyDTO> implements Comparable<OrderTypePropertyDTO> {
	...
	public boolean equals(Object o) {
		...
		OrderTypePropertyDTO that = (OrderTypePropertyDTO) o;
	...
	@Override
	public int compareTo(@NotNull OrderTypePropertyDTO o) {
