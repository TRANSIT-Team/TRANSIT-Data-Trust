...
@NoArgsConstructor
@ToString
@Relation(collectionRelation = "costProperties", itemRelation = "costProperty")
public class CostPropertyDTO extends AbstractDTOIdCanBeNull<CostPropertyDTO> implements Comparable<CostPropertyDTO> {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof CostPropertyDTO)) return false;
		if (!super.equals(o)) return false;
		CostPropertyDTO that = (CostPropertyDTO) o;
	...
	@Override
	public int compareTo(@NotNull CostPropertyDTO o) {
