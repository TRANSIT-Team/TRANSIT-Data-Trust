...
@Service("securityCompanyServiceOneLess")
public class HasAuthorityCompanyOneLess {
	...
	public final boolean hasAnyAuthority(String... authorities) {
		...
		var lastUriComponent = uriComponents.getPathSegments().get(uriComponents.getPathSegments().size() - 2);
