...
@Setter
@Node("UA")
public class UserAttributeClazz implements Serializable {
	@Id
	private UUID id;
	private String name;
	...
	public UserAttributeClazz() {
		this.properties = "";
		this.labels = new HashSet<>();
		this.entityClass = "";
	}
	
	public UserAttributeClazz(UUID id, String name, ClazzType type, Map<String, String> properties, String entityClass) {
	...
	public UserAttributeClazz(UUID id, String name, ClazzType type, String entityClass) {
		this.id = id;
		this.name = name;
		this.type = type;
		this.properties = "";
	...
	public UserAttributeClazz(String name) {
		this.name = name;
		this.labels = new HashSet<>();
	}
	...
	public UserAttributeClazz addProperty(String key, String value) {
	...
	public boolean equals(Object o) {
		if (!(o instanceof UserAttributeClazz n)) {
			return false;
		}
