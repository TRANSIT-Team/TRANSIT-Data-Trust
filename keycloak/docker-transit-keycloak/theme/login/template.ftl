...
<div class="circle-top"></div>
  <!--  <div id="kc-logo"><a href="${properties.kcLogoLink!'#'}"><div id="kc-logo-wrapper"><img src="${url.resourcesPath}/img/transit-logo.svg" alt="logo" class="logo w-100"></div></a></div>
...
-->
    <div id="kc-container" class="${properties.kcContainerClass!}">
        <div id="kc-container-wrapper" class="${properties.kcContainerWrapperClass!}">
            ...
            <div id="kc-content" class="mdc-card box ${properties.kcContentClass!}">
                <div id="kc-header" class="${properties.kcHeaderClass!}">

                    <div id="kc-logo">
                       <!-- <a href="${properties.kcLogoLink!'#'}"> -->
                            <div id="kc-logo-wrapper">
                                <img src="${url.resourcesPath}/img/transit-logo.svg" alt="logo" class="logo w-100">
                            </div>
                        <!--</a>-->
                    </div>
