...
export class CustomReuseStrategy implements RouteReuseStrategy {
  ...
  shouldDetach(route: ActivatedRouteSnapshot): boolean {
    ...
    let reuseComponent: any = route.data['reuseComponent'];

    if (reuseComponent == true || reuseComponent == false) {
     // //console.log("detachingcustom....", route, "return: ", reuseComponent);
    ...
    if (route.routeConfig != undefined) {
      if (route.routeConfig.path != undefined) {
        ...
        if (canAttach) {
          ...
          if (reuseComponent == true || reuseComponent == false) {
          //  //console.log("deciding to attach...custom...", reuseComponent,);
  ...
  //  //console.log('reuseComponentCustom', future.data['reuseComponent'])

    let reuseComponent: any = future.data['reuseComponent'];


    if (reuseComponent == true || reuseComponent == false) {
   //   //console.log('customReturn', future.data['reuseComponent']);
